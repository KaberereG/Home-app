...
if(!s.toString().isEmpty()){
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<PlumberClass, PlumberViewHolder> FBRA = new FirebaseRecyclerAdapter<PlumberClass, PlumberViewHolder>(
            ...
            @Override
            protected void populateViewHolder(PlumberViewHolder viewHolder, final PlumberClass model, int position) {
                ...
                viewHolder.clickCall(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (ActivityCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                            ...
                            ActivityCompat.requestPermissions(Plumber_view.this,new String[]{android.Manifest.permission.CALL_PHONE},CALL_PERMISSION_CODE);
                        }
                        startActivity(i);
                    }
                });
