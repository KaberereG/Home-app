...
public class HouseHelp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ageN=new MyDobTextDatePicker(HouseHelp.this,R.id.age);
...
//       //spinner
        ...
        ArrayAdapter<String> myAdaper=new ArrayAdapter<String>(HouseHelp.this,
...
//        }
        ...
        ArrayAdapter<String> myAdaperTwo=new ArrayAdapter<String>(HouseHelp.this,
                    ...
                    newPost.child("username").setValue(dataSnapshot.child("username").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(HouseHelp.this,"Error occured "+message,Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
