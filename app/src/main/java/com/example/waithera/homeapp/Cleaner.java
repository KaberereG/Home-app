...
public class Cleaner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdaper=new ArrayAdapter<String>(Cleaner.this,
...
//instantiating database reference and firebase auth
    ...
    public void submitButtonClicked(View view) {
        final String workerN = firstName.getText().toString().trim();
        ...
        if (TextUtils.isEmpty(prevEmp)) {
            Toast.makeText(this, "Please enter your referee contact", Toast.LENGTH_SHORT).show();
            return;
        }
                    ...
                    newPost.child("username").setValue(dataSnapshot.child("username").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(Cleaner.this,"Error occured "+message,Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
